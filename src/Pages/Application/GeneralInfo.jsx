  ...
  return (
    <div className="input-page">
      ...
      <div className="input-group">
        ...
        <div className="field-group check-group">
          <label className="checkbox-group">
            <Field type="checkbox" name="saglasnost" className="checkbox" />
            Saglasan/na sam da se moji podaci podele sa kompanijama učesnicama
            projekta
          </label>
          <ErrorMessage name="saglasnost" component="div" className="error" />
        </div>
      </div>
      <div className="input-group">
        <div className="label-group">
          <label htmlFor="newsletter" className="desc">
            Imejl novosti i obaveštenja
          </label>
        </div>
        <div className="field-group check-group">
          <label className="checkbox-group">
