            ...
            >
                {render && (
                    ...
                    >
                        ...
                        <h2 style={{ color: "#cc203a", padding: "0rem 2rem" }}>
                            Uputstvo
                        </h2>
                        <p style={{ padding: "0.5rem 2.5rem", color: "#fff" }}>
                            Najlakši način da dobijete URL slike jeste da sliku
                            okačite na Imgur. Nakon što otvorite sajt{" "}
                            <a
                            ...
                            izaberite New post opciju i prevucite vašu sliku.
                            Nakon što se slika upload-uje pritisnite desni klik
                            na sliku i izaberite opciju Copy Image Address.
                        </p>
                        <div className="input-field">
                        ...
                        <p style={{ padding: "0.5rem 2.5rem", color: "#fff" }}>
                            Nakon što kliknete dugme download pdf iskočiće Vam
                            prozor na kome treba da izaberete određene postavke.
                            Kao destination birate PDF, za Pages birate Custom i
                            unosite 1-1. Nakon toga otvorite više opcija i
                            postavite margine na None, izaberete opciju da se
                            prikaze pozadina i iskljucite opciju za header-e i
                            footer-e.
                        </p>
                        <div className="input-field">
                            <motion.button
