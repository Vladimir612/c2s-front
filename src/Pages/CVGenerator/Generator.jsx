      ...
      >
        {render && (
          <div className={showPreview ? "input-space none" : "input-space"}>
            ...
            <h2 style={{ color: "#cc203a", padding: "0rem 2rem" }}>Uputstvo</h2>
            <p style={{ padding: "0.5rem 2.5rem", color: "#fff" }}>
              Nakon što kliknete dugme download pdf iskočiće Vam prozor na kome
        ...
        >
          <div className="input-field">
            <motion.button
              className={render ? "pdf-dugme show-on-resize" : "none"}
              onClick={() => {
          ...
          >
            <div className="left-pane">
              ...
              <img
                ...
                maxLength={1000}
              />
              <h2 className="opis-cv" style={{ borderColor: temaInput }}>
                O MENI
              </h2>
                ...
                tehnologije.map((t) => {
                  return (
                    <div className="tehnologija">
                      ...
                      <p className="tehnologija-nivo">{t.nivoZnanjaInput}</p>
                    </div>
                  );
                })}
            </div>
            <div className="right-pane">
              <div className="contact-info" style={{ borderColor: temaInput }}>
              ...
              <h2 className="opis-cv-obr" style={{ borderColor: temaInput }}>
                OBRAZOVANJE
              </h2>
                ...
                obrazovanje.map((o) => {
                  return (
                    <div className="obrazovanje">
                      <h2 className="ustanova-naziv">{o.input1}</h2>
                      <p className="ustanova-vreme">{o.input2}</p>
                      <p className="ustanova-content">{o.input3}</p>
                    </div>
                  );
                })}
              <h2 className="opis-cv" style={{ borderColor: temaInput }}>
                ...
                radnoIskustvo.map((r) => {
                  return (
                    <div className="iskustvo">
                      <h2 className="iskustvo-naziv">{r.input1}</h2>
                      <p className="iskustvo-vreme">{r.input2}</p>
                      <p className="iskustvo-content">{r.input3}</p>
                    </div>
                  );
                })}
            </div>
