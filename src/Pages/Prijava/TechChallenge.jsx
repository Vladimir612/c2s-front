            ...
            <div className="input-group">
                <div className="label-group">
                    <label htmlFor="fonMail" className="desc">
                        Upiši FON mejl, ukoliko ga imaš
                    </label>
                </div>
            ...
            <div className="input-group">
                <div className="label-group">
                    <label htmlFor="ucestvovao" className="desc">
                        Da li si do sad učestvovao/la u rešavanju IT studije
                        slučaja?*
                    </label>
                </div>
                <div className="field-group">
            ...
            <div className="input-group">
                <div className="label-group">
                    ...
                    <p className="more-info">
                        Unesite puno ime i prezime osoba. Timovi se mogu
                        sastojati od 3 ili 4 osobe. Moguće je i individualno
                        prijavljivanje.
                    </p>
                </div>
                <div className="field-group">
            ...
            <div className="input-group">
                <div className="label-group">
                    <label htmlFor="studyComp" className="desc">
                        Izaberi do dve kompanije za koje bi najviše voleo/la da
                        radiš studiju slučaja?*
                    </label>
                </div>
