...
const Panel = () => {
  const panelParticipants = [
    // {
    //   moderator: true,
    //   name: "Stefan Krstović",
    //   position: "Asistent na Faкultetu organizacionih nauka",
    //   hasTold:
    //     "Ja sam legenda",
    ...
    // },
    {
      ...
      photo: AnaNikolic,
      companyImage: a1,
      companyLink: "/nasi-partneri/a1",
    },
    {
      moderator: false,
      name: "Ivan Divić",
      position: "Direktor kompanije",
      hasTold:
      ...
      photo: IvanDivic,
      companyImage: adacta,
      companyLink: "/nasi-partneri/adacta",
    },
    // {
    //   moderator: false,
    //   name: "Stefan Gavrilović",
    //   position: "Profesor na Faкultetu organizacionih nauka",
    //   hasTold:
    ...
    //   companyImage: raiffeisen,
    //   companyLink: "/nasi-partneri/raiffeisen",
    // },
    {
      moderator: false,
      name: "Goran Vidić",
      ...
      photo: GoranVidic,
      companyImage: prime,
      companyLink: "/nasi-partneri/prime-software",
    },
    {
      moderator: false,
      name: "Vuk Pašković",
      ...
      photo: VukPaskovic,
      companyImage: eyesee,
      companyLink: "/nasi-partneri/eyesee",
    },
    {
      moderator: false,
      ...
      companyImage: semos,
      companyLink: "/nasi-partneri/semos-education",
    },
  ];
  return (
