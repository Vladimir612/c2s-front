...
const ONama = () => {
    ...
    const coreTim = {
        imeTima: "CORE TIM",
        oTimu: "Tim koordinatora, glavni zaslužni i odgovorni za uspešnu realizaciju projekta, svojim iskustvom i znanjem uspešno je organizovao i upravljao celokupnim projektom. 🤓",
    ...
    const itTim = {
        imeTima: "IT TIM",
        oTimu: "Tim za informacione tehnologije marljivo je radio na izradi veb sajta projekta gde možete pronaći sve neophodne informacije u vezi projekta. 💻",
    ...
    const dizajnTim = {
        imeTima: "DIZAJN TIM",
        oTimu: "Tim za dizajn kroz vizuelnu prezentaciju projekta pokazao je svoju kreativnost i veštine. 🎨",
    ...
    const crTim = {
        imeTima: "CR TIM",
        oTimu: "Tim za odnose sa kompanijama je zaslužan za ostvarivanje partnerstava koji doprinose realizaciji projekta na visokom nivou. 💰",
    ...
    const hrTim = {
        imeTima: "HR TIM",
        oTimu: "Tim za ljudske resurse vodio je računa da članovi svih organizacionih timova dostignu svoj pun potencijal i upravljao selekcijom prijavljenih kandidata. 👩🏻‍🤝‍👨🏼",
    ...
    const prTim = {
        imeTima: "PR TIM",
        oTimu: "Tim za odnose sa javnošću bio je zadužen za novinarske poslove poput pisanja tekstova, promocije, prezentovanje samog projekta u najboljem svetlu, kao i ostvarivanje medijskih saradnji. 🗞",
    ...
    const logistikaTim = {
        imeTima: "LOGISTIKA",
        oTimu: "Tim za logistiku osmislio je operacioni plan celokupnog događaja i postarao se da sve prođe u najboljem redu. 📆",
            ...
            <div className="o-nama-container">
                ...
                <div class="o-nama-flex">
                    ...
                    >
                        <h2>O FONISU</h2>
                        <p>
                            Udruženje studenata informatike FONIS je studentska,
                            nevladina i neprofitna organizacija sa Fakulteta
                            organizacionih nauka. Okuplja buduće IT stručnjake u
                            cilju učestvovanja na stručnim predavanjima,
                            kursevima, takmičenjima i seminarima, rada na
                            projektima, kao i ostvarivanja stručnih praksi u IT
                            oblastima. Zajedničkim zalaganjem svih članova
                            udruženja, FONIS već dugi niz godina radi na
                            organizaciji i realizaciji nekoliko edukativnih i
                            takmičarskih projekata iz sveta IT-ja, među kojima
                            je i upravo projekat Kompanije studentima.
                        </p>
                    </motion.div>
                    <motion.div
                ...
                >
                    ...
                    >
                        <div className="left-content">
                            <h2>C2S</h2>
                            <p>
                                Kompanije studentima predstavlja projekat čiji
                                je organizator Udruženje studenata informatike
                                FONIS, a za cilj ima da kroz zabavan i
                                interaktivan način omogući svim zainteresovanim
                                učesnicima da nauče nešto novo iz oblasti
                                informacionih tehnologija. Na panel diskusiji
                                ćeš dobiti priliku da čuješ savete i priče iz
                                poslovnih praksi koje ti mogu značiti kada se
                                budeš našao na mestu praktikanta. Pored panel
                                diskusije, na radionicama, koje će drzati
                                predstavnici kompanija, dobićeš priliku da
                                unaprediš svoje znanje u izabranoj oblasti iz
                                ITa. Tech challenge je deo projekta na kome je
                                tvoj zadatak da nađeš rešenje za realan problem
                                sa kojim se susreću IT kompanije. Na kraju,
                                važan deo ovog projekta predstavlja i speed
                                dating, gde ćeš se naći u ulozi kandidata za
                                posao ili praksu i tako dobiti priliku da osetiš
                                kako izgleda pravi intervju koji je neophodan za
                                ulazak u svaku IT kompaniju. Generalni
                                pokrovitelji projekta su Raiffeisen banka💵,
                                Adacta💻, A1📞, Semos📚, Prime software💿, Eye
                                see⌨️. Čekamo tvoju prijavu! 👍🏼
                            </p>
                        </div>
